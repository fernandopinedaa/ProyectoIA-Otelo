...
características para la red. La interfaz de texto muestra con asteriscos las
...
El proyecto está preparado para poder mostrar tres tipos de ejecución. La primera es una partida interactiva contra la máquina usando la
interfaz de texto. Esta ejecución permite comprobar que el motor aplica las
reglas correctamente y que el agente devuelve movimientos legales. La segunda es
un torneo corto entre dos agentes, útil para mostrar cómo se comparan los
jugadores sin intervención humana. La tercera es la ejecución del script de
experimentos, que reproduce el pipeline completo de generación de datos,
